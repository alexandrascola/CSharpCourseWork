...
namespace EmployeeDirectoryManager
{
    public sealed class Employee
    {
        ...
        {
            //Add Validaiton Here
            if (string.IsNullOrWhiteSpace(id)) throw new ArgumentException("Employee ID required.");
            ...
            if (salary < 0) throw new ArgumentException("Salary must be positive number.");
