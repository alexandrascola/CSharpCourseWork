using ITSupportTicketManagerApp;
...
public class Program
{
    public static void Main()
    {
        ...
        //Main While Loop to Control Input
        bool running = true;
        while (running)
        {
            Console.WriteLine("\nMenu:");
            ...
            switch (choice)
            {
                ...
                case "8": Console.WriteLine($"Open / In Progress Tickets: {manager.GetOpenCount()}"); break;
    ...
    private static void ChangeStatusMenu(TicketManager manager, bool close)
    {
        ...
        if (t is null) { Console.WriteLine("Not found.");
            return;
        }
