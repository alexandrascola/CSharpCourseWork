...
namespace HotelBookingManager
{
    public sealed class Booking
    {
        ...
        public Booking(string roomNumber, string guestName, DateTime checkIn, DateTime checkOut)
        {
            ...
            if (string.IsNullOrWhiteSpace(roomNumber)) throw new ArgumentNullException("Room number is required.");
            if (string.IsNullOrWhiteSpace(guestName)) throw new ArgumentNullException("Guest name is required.");
