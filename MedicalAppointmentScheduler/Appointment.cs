...
namespace MedicalAppointmentScheduler
{
    public class Appointment
    {
        ...
        public Appointment(string id, string patientName, string providerName, DateTime start, DateTime end, string room)
        {
            ...
            if (string.IsNullOrEmpty(id)) throw new ArgumentException("Id cannot be empty.");
            if (string.IsNullOrEmpty(patientName)) throw new ArgumentException("Patient name cannot be empty.");
            if (string.IsNullOrEmpty(providerName)) throw new ArgumentException("Provider name cannot be empty.");
